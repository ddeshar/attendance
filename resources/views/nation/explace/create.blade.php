                ...
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div class="clearfix">      <div class="pull-right">
                                 <a class="btn btn-primary" href="{{ route('explace.index') }}"> Back</a>
                             </div></div>
                    </div>
                    <div class="x_content">
  ...
  <div class="row">
    <div class="col-md-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          @if(isset($explaces))
      <h2>อัพเดทข้อมูล สนามสอบต่างประเทศ <small>explace nation-gongtham</small></h2>
@else

      <h2>ลงทะเบียน สนามสอบต่างประเทศ <small>explace nation-gongtham</small></h2>
@endif
        ...
        <div class="x_content">
          ...
          @if(isset($explaces))
    {{ Form::model($explaces, ['route' => ['explace.update', $explaces->id], 'method' => 'patch']) }}
@else

    {!! Form::open(array('route' => 'explace.store','method'=>'POST')) !!}
@endif

	<div class="row">

    <div class="form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12">ชื่อสนามสอบ</label>
      <div class="col-md-3 col-sm-3 col-xs-3">

          <input type="text" class="form-control" id="inputSuccess2" placeholder="ชื่อสนามสอบ" name="th_explace" value="{{ isset($explaces) ? $explaces->th_explace : '' }}">
...
<div class="row">
    ...
    <div class="form-group">
      <label class="control-label col-md-3 col-sm-3 col-xs-12">ชื่อสนามสอบ(อังกฤษ)</label>
      <div class="col-md-3 col-sm-3 col-xs-3">

        <input type="text" class="form-control has-feedback-left" id="inputSuccess3" placeholder="ชื่อสนามสอบ" name="en_explace"  value="{{ isset($explaces) ? $explaces->en_explace : '' }}">
        <span class="fa fa-map-marker form-control-feedback left" aria-hidden="true"></span>
      </div>
    </div>
</div>
<div class="row">
    <div class="form-group">
      ...
      <div class="col-md-3 col-sm-3 col-xs-3">
         ...
         {!! Form::select('id_country',[''=>'--- เลือกประเทศ ---']+$country->toArray(), isset($explaces) ? $explaces->id_country : null,array('class'=>'select2_single form-control' , 'tabindex' => '-1')) !!}
